...
export const ui = {
  es: {
    ...
    "qual.degree": "Formación Académica",
  ...
  en: {
    ...
    "qual.degree": "Academic Background",
    ...
    // Extra texts for interactive form
    "contact.placeholder": "Hi Juanpe, I'd like to discuss a project...",
  },
} as const;
